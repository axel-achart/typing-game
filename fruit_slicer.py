...
def menu_main():
    ...
    while True:
        ...
        text_display("Press 1 to play",50,50,BLACK)
        text_display("Press 2 to see the scores",50,100,BLACK)
        text_display("Press 3 to change the difficulty",50,150,BLACK)
        text_display("Press 4 to change the player",50,200,BLACK)
        text_display("Press 5 to change the gamemode",50,250,BLACK)
        text_display("Press 6 to quit",50,300,BLACK)
        pygame.display.flip()
